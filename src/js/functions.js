export function setTimer() {
  const daysElement = document.querySelector(
    ".section-6__time-part--days .section-6__time-part-value"
  );
  const hoursElement = document.querySelector(
    ".section-6__time-part--hours .section-6__time-part-value"
  );
  const minutesElement = document.querySelector(
    ".section-6__time-part--minutes .section-6__time-part-value"
  );
  const secondsElement = document.querySelector(
    ".section-6__time-part--seconds .section-6__time-part-value"
  );
...
export function triggerRegistration() {
  ...
  let closeRegisterFormButton = document.querySelector(
    ".register-popup__close-button"
  );
...
export function sendRegistrationForm() {
  ...
  let sendRegistrationFormButton = document.querySelector(
    ".register-popup__button"
  );
  let registerForm = document.querySelector(".register-popup");
  let successMessage = document.querySelector(".form-sent-popup");
  let closeSuccessMessageButton = document.querySelector(
    ".form-sent-popup__button"
  );
